...
parser.add_argument('--f_i', 
                    help='Expression values. By default cells are rows and columns are genes', required=True)
...
data = feather_utils.import_feather(args.f_i)
print("\tDone")
if args.cellColumns:
...
feather_utils.export_feather(data, args.fo)
